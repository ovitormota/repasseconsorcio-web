        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div>
              ...
              <Link
                href="/"
                className="flex items-center space-x-2 text-lg font-medium text-indigo-500 dark:text-gray-300"
              >
                <Image
                  src="/img/logo.png"
                  alt="RC"
            ...
            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              <p>
                O Repasse Consórcio é uma plataforma de consórcio que conecta
                pessoas que querem vender suas cotas com pessoas que querem
                comprar.
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {legal.map((item, index) => (
                <div
                  key={index}
                  href=""
                  className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:focus:bg-trueGray-700"
                >
                  {item}
                </div>
              ))}
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              <a
                href="https://instagram.com/repasseconsorcio"
                target="_blank"
                rel="noopener"
              >
